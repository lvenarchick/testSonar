	...
	<div class="body">
		...
		<div role="main" class="main">
			...
			<div class="container">
				<div class="row">
					<div class="col">
						<h2>Your connection has timed out!</h2>
						<p>Please close your browser before trying to launch this website again.</p>
						<p>Feel free to contact us any time at ${applicationScope['cpa-website-assistance-phone']}.</p>
					</div>
				</div>
			</div>
