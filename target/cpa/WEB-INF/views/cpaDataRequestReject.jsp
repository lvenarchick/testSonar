			...
			<div class="container">
				<div class="row">
					<div class="col">
						...
						<p>Your address does not meet the requirements for request submission.</p>
						<p>If you need assistance or have any questions, please call us at ${applicationScope['cpa-website-phone']}.</p>
					</div>
				</div>
			</div>
