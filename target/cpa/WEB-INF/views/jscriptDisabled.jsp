	...
	<div class="body">
					...
					<div class="header-row">
						<div class="header-column">
							<div class="header-logo">
								<a href="${applicationScope['cpa-website-href-url']}"><img class="logo-default" alt="${applicationScope['cpa-website-name']}" width="${applicationScope['cpa-website-logo-width']}" height="${applicationScope['cpa-website-logo-height']}" src="resources/images/${applicationScope['cpa-website-logo-name']}"></a> 
							</div>
						</div>
					</div>
		...
		<div role="main" class="main">
			...
			<div class="container">
				<div class="row">
					<div class="col">
						<h2>Your web browser does not currently support JavaScript.</h2>
						<p>In order to use this website, you must enable your browser to run JavaScript!</p>
						<p>Once you have enabled JavaScript please <a href="${applicationScope['cpa-website-jsdisabled-url']}">click here</a></p>
					</div>
				</div>
			</div>
